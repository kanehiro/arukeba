...
<div class="container">
	...
	<div class="row">
		...
		<form class="form-horizontal" name="route_srch" method="post" action="route_list.php">
			<fieldset>
			<legend>検索条件</legend>
					...
					<tbody>
						...
						<tr>
							<td class="text-center">
								<a href="JavaScript:m_upd('{$id[routelst]}','route_map.php')" class="btn btn-primary btn-sm">ルート図</a>
							</td>
							<td>{$id[routelst]}</td>
